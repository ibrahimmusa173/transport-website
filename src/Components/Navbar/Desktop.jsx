            ...
            <div className="hidden lg:block h-12 w-full lg:flex items-center lg:justify-between sticky top-0 z-[1000] rounded-b-2xl bg-gradient-to-r from-white backdrop-blur bg-white/90 shadow-sm">
                ...
                <div className="lg:flex lg:justify-start">
                    <div className="lg:flex lg:items-center hidden lg:w-[700px]">
                        ...
                        <a 
                            className={`whitespace-nowrap lg:ml-8 xl:ml-6 lg:text-xs xl:text-base xl:text-zinc-700 h py-3 transition-colors ${isActive("OurFleet")}`} 
                            href="/OurFleet"
                        >
                            Our Fleet
                        </a>
                        <a 
                            className={`whitespace-nowrap lg:ml-8 xl:ml-6 lg:text-xs xl:text-base xl:text-zinc-700  py-3 transition-colors ${isActive("About")}`} 
                            href="/About"
                        >
                            About Us
                        </a>
                        <a 
                            className={`whitespace-nowrap lg:ml-8 xl:ml-6 lg:text-xs xl:text-base xl:text-zinc-700  py-3 transition-colors ${isActive("Contact")}`} 
                            href="/Contact"
                        >
                            Contact Us
                        </a>
