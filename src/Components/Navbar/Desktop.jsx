...
function Desktop(){
    ...
    return(
        ...
        <div className=" h-10 w-60 pl-8"><img className="w-full h-full " src="images/Logo/dynamicLeo.png" alt="" /></div>
        ...
        <div className="flex">
          ...
          <div className="  lg:flex   lg:items-center hidden  lg:w-[800px]">
           <a className="cursor-pointer lg:ml-20   text-zinc-1000 lg:text-xs xl:text-base xl:text-zinc-700 "href="/Home">Home</a>
            ...
            <a className=" flex lg:ml-2.5 xl:ml-6 lg:text-xs text-zinc-1000 xl:text-base xl:text-zinc-700  " href="/Home">Services<i className="fa-solid fa-caret-down pt-1 pl-1"></i></a>
           ...
           <a className="block px-4 py-2 hover:bg-gray-100 transition-colors
                ...
                <a className="lg:ml-2.5 xl:ml-6 text-zinc-1000 lg:text-xs xl:text-base xl:text-zinc-700 " href="OurFleet">OurFleet</a>
                <a className="lg:ml-2.5 xl:ml-6 text-zinc-1000 lg:text-xs xl:text-base xl:text-zinc-700 " href="About">About Us</a>
                <a className="lg:ml-2.5 xl:ml-6 text-zinc-1000 lg:text-xs xl:text-base xl:text-zinc-700 " href="Contact">Contact Us</a>
